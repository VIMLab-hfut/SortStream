...
//     .domain([0,layersData[0].length])//layers[0].size.length
//     .range([0,0.95*div_width*(layersData[0].length-1)/layersData[0].length]);
// let axis = d3.axisBottom(scale).ticks(layersData[0].length).tickSize(580);
